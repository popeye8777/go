...
func allocm(_p_ *p, fn func()) *m {
	...
	if iscgo || GOOS == "solaris" || GOOS == "illumos" || GOOS == "windows" || GOOS == "plan9" || GOOS == "darwin" || GOOS == "openbsd" {
		mp.g0 = malg(-1)
	} else {
...
func sigprof(pc, sp, lr uintptr, gp *g, mp *m) {
	...
	if n <= 0 {
		...
		n = 0
		if (GOOS == "windows" || GOOS == "solaris" || GOOS == "illumos" || GOOS == "darwin" || GOOS == "openbsd" || GOOS == "aix") && mp.libcallg != 0 && mp.libcallpc != 0 && mp.libcallsp != 0 {
