// go run mksyscall.go -openbsd -tags openbsd,amd64,go1.14 syscall_bsd.go syscall_openbsd.go syscall_openbsd_amd64.go
// Code generated by the command above; see README.md. DO NOT EDIT.

// +build openbsd,amd64,go1.14
...
//go:cgo_import_dynamic libc_poll poll "libc.so.96.0"
...
//go:cgo_import_dynamic libc_mlock mlock "libc.so.96.0"
...
//go:cgo_import_dynamic libc_mlockall mlockall "libc.so.96.0"
...
//go:cgo_import_dynamic libc_mprotect mprotect "libc.so.96.0"
...
//go:cgo_import_dynamic libc_munlock munlock "libc.so.96.0"
...
//go:cgo_import_dynamic libc_munlockall munlockall "libc.so.96.0"

// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT

func pipe2(p *[2]_C_int, flags int) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_pipe2_trampoline), uintptr(unsafe.Pointer(p)), uintptr(flags), 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Getdents(fd int, buf []byte) (n int, err error) {
	...
	r0, _, e1 := syscall_syscall(funcPC(libc_getdents_trampoline), uintptr(fd), uintptr(_p0), uintptr(len(buf)))
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func ppoll(fds *PollFd, nfds int, timeout *Timespec, sigmask *Sigset_t) (n int, err error) {
	r0, _, e1 := syscall_syscall6(funcPC(libc_ppoll_trampoline), uintptr(unsafe.Pointer(fds)), uintptr(nfds), uintptr(unsafe.Pointer(timeout)), uintptr(unsafe.Pointer(sigmask)), 0, 0)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func libc_ppoll_trampoline()

//go:linkname libc_ppoll libc_ppoll
//go:cgo_import_dynamic libc_ppoll ppoll "libc.so.96.0"
...
//go:cgo_import_dynamic libc_faccessat faccessat "libc.so.96.0"
...
//go:cgo_import_dynamic libc_fchmodat fchmodat "libc.so.96.0"
...
//go:cgo_import_dynamic libc_fchownat fchownat "libc.so.96.0"
...
func Getrtable() (rtable int, err error) {
	r0, _, e1 := syscall_rawSyscall(funcPC(libc_getrtable_trampoline), 0, 0, 0)
	rtable = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func libc_getrtable_trampoline()

//go:linkname libc_getrtable libc_getrtable
//go:cgo_import_dynamic libc_getrtable getrtable "libc.so.96.0"
...
func Gettimeofday(tv *Timeval) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_gettimeofday_trampoline), uintptr(unsafe.Pointer(tv)), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Issetugid() (tainted bool) {
	r0, _, _ := syscall_syscall(funcPC(libc_issetugid_trampoline), 0, 0, 0)
	tainted = bool(r0 != 0)
	return
}
...
func Kill(pid int, signum syscall.Signal) (err error) {
	_, _, e1 := syscall_syscall(funcPC(libc_kill_trampoline), uintptr(pid), uintptr(signum), 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
//go:cgo_import_dynamic libc_linkat linkat "libc.so.96.0"
...
//go:cgo_import_dynamic libc_mkdirat mkdirat "libc.so.96.0"
...
func Mkfifoat(dirfd int, path string, mode uint32) (err error) {
	...
	_, _, e1 := syscall_syscall(funcPC(libc_mkfifoat_trampoline), uintptr(dirfd), uintptr(unsafe.Pointer(_p0)), uintptr(mode))
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func libc_mkfifoat_trampoline()

//go:linkname libc_mkfifoat libc_mkfifoat
//go:cgo_import_dynamic libc_mkfifoat mkfifoat "libc.so.96.0"
...
func Mknodat(dirfd int, path string, mode uint32, dev int) (err error) {
	...
	_, _, e1 := syscall_syscall6(funcPC(libc_mknodat_trampoline), uintptr(dirfd), uintptr(unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func libc_mknodat_trampoline()

//go:linkname libc_mknodat libc_mknodat
//go:cgo_import_dynamic libc_mknodat mknodat "libc.so.96.0"

// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT

func Nanosleep(time *Timespec, leftover *Timespec) (err error) {
	_, _, e1 := syscall_syscall(funcPC(libc_nanosleep_trampoline), uintptr(unsafe.Pointer(time)), uintptr(unsafe.Pointer(leftover)), 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
//go:cgo_import_dynamic libc_readlinkat readlinkat "libc.so.96.0"
...
//go:cgo_import_dynamic libc_renameat renameat "libc.so.96.0"
...
func Setegid(egid int) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_setegid_trampoline), uintptr(egid), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Setresgid(rgid int, egid int, sgid int) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_setresgid_trampoline), uintptr(rgid), uintptr(egid), uintptr(sgid))
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func libc_setresgid_trampoline()

//go:linkname libc_setresgid libc_setresgid
//go:cgo_import_dynamic libc_setresgid setresgid "libc.so.96.0"

// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT

func Setresuid(ruid int, euid int, suid int) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_setresuid_trampoline), uintptr(ruid), uintptr(euid), uintptr(suid))
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func libc_setresuid_trampoline()

//go:linkname libc_setresuid libc_setresuid
//go:cgo_import_dynamic libc_setresuid setresuid "libc.so.96.0"
...
func Setrtable(rtable int) (err error) {
	_, _, e1 := syscall_rawSyscall(funcPC(libc_setrtable_trampoline), uintptr(rtable), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func libc_setrtable_trampoline()

//go:linkname libc_setrtable libc_setrtable
//go:cgo_import_dynamic libc_setrtable setrtable "libc.so.96.0"
...
//go:cgo_import_dynamic libc_symlinkat symlinkat "libc.so.96.0"
...
func utimensat(dirfd int, path string, times *[2]Timespec, flags int) (err error) {
	...
	_, _, e1 := syscall_syscall6(funcPC(libc_utimensat_trampoline), uintptr(dirfd), uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(times)), uintptr(flags), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
